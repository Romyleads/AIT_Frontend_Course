...
if (user) {
  authControls.innerHTML = `
    <p style="display: flex; align-items: center; gap: 8px;text-align: center;justify-content: center">
      Привет,
      <img src="${user.avatar}" alt="avatar" width="24" height="24" style="border-radius: 50%; object-fit: cover;" referrerpolicy="no-referrer" crossorigin="anonymous">
      <a href="profile" style="font-weight: bold;">${user.name}</a>
      <a href="logout" style="margin-left: 10px;">Выйти</a>
    </p>
  `;
} else {
  authControls.innerHTML = `
